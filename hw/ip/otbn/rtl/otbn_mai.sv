...
#(
  ...
  assign out_cnt_load_val_d = mai_wipe_i ? cnt_load_val : in_cnt_load_val_q;
  ...
  assign ispr_mai_in0_s0_d = ispr_mai_in0_s0_sec_wipe_i ? mai_ispr_urnd.urnd      :
                             ispr_mai_in0_s0_wr_i       ? ispr_mai_in0_s0_wdata_i :
                             ispr_mai_in0_s0_q;

  assign ispr_mai_in0_s1_d = ispr_mai_in0_s1_sec_wipe_i ? mai_ispr_urnd.urnd      :
                             ispr_mai_in0_s1_wr_i       ? ispr_mai_in0_s1_wdata_i :
                             ispr_mai_in0_s1_q;

  assign ispr_mai_in1_s0_d = ispr_mai_in1_s0_sec_wipe_i ? mai_ispr_urnd.urnd      :
                             ispr_mai_in1_s0_wr_i       ? ispr_mai_in1_s0_wdata_i :
                             ispr_mai_in1_s0_q;

  assign ispr_mai_in1_s1_d = ispr_mai_in1_s1_sec_wipe_i ? mai_ispr_urnd.urnd      :
                             ispr_mai_in1_s1_wr_i       ? ispr_mai_in1_s1_wdata_i :
                             ispr_mai_in1_s1_q;

  always_comb begin : proc_res_s0_next
    // Bus access
    ispr_mai_res_s0_d = ispr_mai_res_s0_sec_wipe_i ? mai_ispr_urnd.urnd      :
  ...
  always_comb begin : proc_res_s1_next
    // Bus access
    ispr_mai_res_s1_d = ispr_mai_res_s1_sec_wipe_i ? mai_ispr_urnd.urnd      :
