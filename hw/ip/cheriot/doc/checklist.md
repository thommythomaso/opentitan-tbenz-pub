...
Security      | [SEC_CM_RND_CNST][]          | N/A         | No compile-time random netlist constants.
Security      | [SEC_CM_NON_RESET_FLOPS][]   | Not Started |
Security      | [SEC_CM_SHADOW_REGS][]       | N/A         | The only CSR is `ALERT_TEST`, which holds no critical control function.
...
### V1
 ...
 Type         | Item                                  | Resolution  | Note/Collaterals
--------------|---------------------------------------|-------------|------------------
Documentation | [DV_DOC_DRAFT_COMPLETED][]            | Done        | [CHERIOT DV document](../dv/README.md)
Documentation | [TESTPLAN_COMPLETED][]                | Not Started | [Testplan](../data/cheriot_testplan.hjson)
